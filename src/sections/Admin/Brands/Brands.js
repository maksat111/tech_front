  ...
  const handleUpdateOk = async () => {
    try {
      ...
      const res = await axiosInstance.patch(
        `admin/brand/update/${selectedItem._id}`,
        formData
      );
  ...
  const handleUpdateSelectChange = (e) => {
    ...
    selectOptions.forEach((item) => {
      e.forEach(
        (selected) =>
          item.value == selected &&
          a.push({ _id: item._id, label: selected, value: selected })
      );
    });
  ...
  return (
    <>
        ...
        <div className="banner-add-container">
          ...
          <div className="add-right">
            ...
            <div className="add-picture">
              <img
                className="brand-image"
                src={"http://127.0.0.1:5000/" + selectedItem?.image}
                alt="selected"
              />
              <Upload
                customRequest={handleAddCustomRequest}
      ...
      <div className="page">
        ...
        <div className="brands-header-filters"></div>
        <TableComponent
