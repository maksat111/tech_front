...
function Users() {
    ...
    useEffect(() => {
        axiosInstance.get('admin/list').then(async res => {
    ...
    const handleOk = async () => {
        try {
            ...
            if (newItem) {
                const res = await axiosInstance.patch(`admin/update/${newItem._id}`, { active: !newItem.active });
    ...
    const handleAddOk = async () => {
        ...
        try {
            if (newItem._id) {
                const res = await axiosInstance.patch(`admin/update/${newItem._id}`, formData);
